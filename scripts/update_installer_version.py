...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Flicker Demo Installer\n"
      else:
        line="OutputBaseFilename=Flicker Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Flicker Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Flicker installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Flicker Demo installer\n"
     else:
       line="SetupWindowTitle=Flicker installer\n"
